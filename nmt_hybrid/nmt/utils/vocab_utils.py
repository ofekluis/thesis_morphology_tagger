...
def create_vocab_tables(src_vocab_file, tgt_vocab_file, share_vocab, src_char_vocab_file=""):
  ...
  if src_char_vocab_file:
    src_char_vocab_table = lookup_ops.index_table_from_file(src_char_vocab_file, default_value=UNK_ID)

  return src_vocab_table, tgt_vocab_table, src_char_vocab_table
