...
def create_train_model(
  ...
  char = src_char_vocab_file != ""
  graph = tf.Graph()

  with graph.as_default(), tf.container(scope or "train"):
    src_vocab_table, tgt_vocab_table, src_char_vocab_table = vocab_utils.create_vocab_tables(
      src_vocab_file, tgt_vocab_file, hparams.share_vocab, src_char_vocab_file)
...
class EvalModel(
    collections.namedtuple("EvalModel",
                           ("graph", "model", "src_file_placeholder",
                            "tgt_file_placeholder", "iterator", "char"))):
  pass
